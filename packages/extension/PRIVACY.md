...
- **LLM traffic is not handled by this extension.** If you use Claude Code (or any other MCP client) with Chromanche, the LLM provider that client is configured to use will see the instructions you give it — that traffic flows between the client and the provider directly, not through this extension.
...
Issues, questions: https://github.com/marcobazzani/Chromanche/issues
